...
export const ReservationConfirmedEmail = ({
    ...
    return (
        <BaseLayout previewText="Su reserva con CarCo está confirmada">
            ...
            <Section style={contentSection}>
                ...
                <Text style={subtext}>
                    Gracias por elegir CarCo, {customerName}. Su experiencia comienza ahora. Su número de reserva es <strong>{reservationNumber}</strong>.
                </Text>
